...
MAX_JOBS=7
AVAILABLE_GPUS=(0 1 2 3 4 5 6)      # <<< set your real GPUs here
MAX_RETRIES=1
...
SEMAPHORE=/tmp/gs_semaphore_timefilter_etth1
mkfifo $SEMAPHORE
exec 9<>$SEMAPHORE
rm $SEMAPHORE
...
PY
      ...
      model_id="ETTh1_${seq_len}_${pred_len}_fcv_patch${loss_patchlen}_b${beta}"
...
wait
echo "All TimeFilter ETTh1 fcv search jobs finished."