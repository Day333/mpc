...
SEMAPHORE=/tmp/gs_semaphore_timefilter_ettm2
mkfifo $SEMAPHORE
exec 9<>$SEMAPHORE
rm $SEMAPHORE
...
PY
      ...
      model_id="ETTm2_${seq_len}_${pred_len}_fcv_patch${loss_patchlen}_b${beta}"
...
wait
echo "All TimeFilter ETTm2 fcv search jobs finished."