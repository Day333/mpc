...
SEMAPHORE=/tmp/gs_semaphore_timefilter_pems08
mkfifo $SEMAPHORE
exec 9<>$SEMAPHORE
rm $SEMAPHORE
...
PY
      ...
      model_id="PEMS08_${seq_len}_${pred_len}_fcv_patch${loss_patchlen}_b${beta}"
...
wait
echo "All TimeFilter PEMS08 FCV search jobs finished."