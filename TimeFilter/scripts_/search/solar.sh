...
SEMAPHORE=/tmp/gs_semaphore_timefilter_solar
mkfifo $SEMAPHORE
exec 9<>$SEMAPHORE
rm $SEMAPHORE
...
PY
      ...
      model_id="solar_${seq_len}_${pred_len}_fcv_patch${loss_patchlen}_b${beta}"
...
wait
echo "All Solar TimeFilter FCV search jobs finished."