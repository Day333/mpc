...
if __name__ == '__main__':
    ...
    parser.add_argument('--t_layers', type=int, default=1, help='number of time embedding layers')
    parser.add_argument('--period', type=int, default=24, help='period of time embedding')
